...
export class ListCustomersQueryDto {
  ...
  @ApiPropertyOptional({
    description: 'Filter by taxId (contains, case-insensitive).',
  })
  @IsOptional()
  @IsString()
  @MinLength(1)
  ...
  @ApiPropertyOptional({
    description: 'Filter by phone (contains, case-insensitive).',
  })
  @IsOptional()
  @IsString()
  @MinLength(1)
  ...
  @ApiPropertyOptional({ description: 'If provided, filters by active flag.' })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Alias for isActive (backwards/compat). Prefer isActive.',
  })
  @IsOptional()
  @Transform(({ value }: { value: unknown }) => {
    if (value === undefined) return undefined;
